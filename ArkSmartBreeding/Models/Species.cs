...
public class Species
{
    ...
    public Dictionary<int, double> altBaseStatsRaw { get; set; }
    /// <summary>
    ...
    [JsonProperty]
    public Dictionary<string, double> boneDamageAdjusters { get; set; }
    [JsonProperty]
    ...
    /// </summary>
    [JsonProperty]
    public Dictionary<string, string> statNames { get; set; }
    ...
    /// </summary>
    /// <param name="ignoreVariantsInName">
    ...
    public void InitializeNames(string[] ignoreVariantsInName = null)
    {
        ...
        if (variants != null && variants.Any())
        {
            ...
            IEnumerable<string> filteredVariants = string.IsNullOrEmpty(name)
                ? variants
    ...
    /// </summary>
    /// <param name="arkColors">The loaded ARK color definitions.</param>
    /// <param name="settings">Domain settings controlling color region visibility. Pass null to use defaults.</param>
    ...
    /// </summary>
    /// <param name="settings">Domain settings controlling color region visibility. Pass null to use defaults (all regions shown).</param>
    ...
    /// </summary>
    public void ApplyWildLevelExceptions(Dictionary<string, int>? exceptions)
    {
